...
// good job the app opens, now make it actually do something
function Open_Web () {
    App_Open = "Web Chat"
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    if (spriteutils.isDestroyed(Mouse_Cursor)) {
        ...
        File_Manager_selection = "1" + Mouse_Cursor.y + 11 / 13
        File_Manager_selection = parseInt(File_Manager_selection.charAt(0))
