...
let clipboardName = ""
let clipboardExt = ""
let writeRclickRow = -1
let writeLineClipboard: string = null
let List_Scroll = 0
...
let Library_Icons: Sprite[] = []
let Library_Icon_Names: string[] = []
let Library_Icon_Files: string[] = []
...
let text3 = textsprite.create("> PXT Build 4.1.17", 0, 1)
